                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> 
                            <img alt="image" src="{{ asset(asset(Auth()->user()->image))}}" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
                        ...
                        @if($isAdmin)
                            <li class="dropdown">
                                <a href="{{ route('permission.index') }}" class="nav-link">
                                    <i data-feather="key"></i> Permissions
                                </a>
                            </li>
                        @else
                            @can('permission-view')
                        ...
                        @if($isAdmin)
                            <li class="dropdown">
                                <a href="{{ route('service.index') }}" class="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#999999" viewBox="0 0 16 16">
