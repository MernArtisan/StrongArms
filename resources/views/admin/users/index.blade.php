                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                {{-- <ul class="nav nav-tabs mb-4" id="userTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="customers-tab" data-toggle="tab" href="#customers"
                                            role="tab">Customers</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="providers-tab" data-toggle="tab" href="#providers"
                                            role="tab">Providers</a>
                                    </li>
                                </ul> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($isAdmin || auth()->user()->can('user-edit'))
                                                            <a href="{{ route('all-users.edit', $u->id) }}"
                                                                class="btn btn-sm btn-info">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        @endif
                                                        @if ($isAdmin || auth()->user()->can('user-delete'))
                                                            <form action="{{ route('all-users.destroy', $u->id) }}"
