...
?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="contents text-center">
                                            <h2 class="wow animated fadeInUp" data-wow-duration="1s">Lorem Ipsum</h2>
                                            <p class="mr-lu mr-ru wow animated fadeInDown" data-wow-duration="1.5s">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
						...
						<div class="slider_section_overlay"></div>
                            <div class="container position-relative">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="contents text-center">
                                            <h2 class="wow animated fadeInDown" data-wow-duration="1s">Lorem Ipsum</h2>
                                            <p class="mr-lu mr-ru wow animated fadeInUp" data-wow-duration="1.5s">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            <div class="buttons wow animated fadeInUp" data-wow-duration="2s">
                                                <a href="#" class="btn1">buy now</a>
                                                <a href="#" class="btn2">read more</a>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="contents text-right">
                                            <h2 class="wow animated fadeInRight" data-wow-duration="1s">Lorem Ipsum</h2>
                                            <p class="mr-lu wow animated fadeInRight" data-wow-duration="1.5s">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            <div class="buttons wow animated fadeInUp" data-wow-duration="2s">
                                                <a href="#" class="btn1">buy now</a>
                                                <a href="#" class="btn2">read more</a>
                                            </div>
                        ...
                        <div class="item-thumbnail">
                            <a href="#" class="col-sm-3" data-slide-index="0">
                                <div class="items">
                                    <div class="dbox">
                                        <div class="dleft">
                                            <figure><img src="assets/images/sliders/sm-1.jpg" alt=""></figure>
                                        </div>
                                        <div class="dright">
                                            <div class="content">
                                                <h3>MC5 Carbine</h3>
                            ...
                            <a href="#" class="col-sm-3" data-slide-index="1">
                                <div class="items">
                                    <div class="dbox">
                                        <div class="dleft">
                                            <figure><img src="assets/images/sliders/sm-2.jpg" alt=""></figure>
                                        </div>
                                        <div class="dright">
                                            <div class="content">
                                                <h3>MC5 Carbine</h3>
                            ...
                            <a href="#" class="col-sm-3" data-slide-index="2">
                                <div class="items">
                                    <div class="dbox">
                                        <div class="dleft">
                                            <figure><img src="assets/images/sliders/sm-3.jpg" alt=""></figure>
                                        </div>
                                        <div class="dright">
                                            <div class="content">
                                                <h3>MC5 Carbine</h3>
                            ...
                            <a href="#" class="col-sm-3" data-slide-index="3">
                                <div class="items">
                                    <div class="dbox">
                                        <div class="dleft">
                                            <figure><img src="assets/images/sliders/sm-4.jpg" alt=""></figure>
                                        </div>
                                        <div class="dright">
                                            <div class="content">
                                                <h3>MC5 Carbine</h3>
 ...
 <!--    <section class="banner-area section bg-img af jarallax">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 d-lg-block d-md-none d-none">
                    <div class="banner-img">
                        <figure><img src="assets/images/banner/1.png" alt="" class="w-auto"/></figure>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="banner-con sm-t-center">
                        <h2>New MC7 Carbine Gun</h2>
                        <div class="price">
                            <del>$2,895.00</del>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="heading1">
                                <a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="cnc">
                                    <h3>Modern Weapon Trainning Seminar</h3>
                                    <ul>
                                        <li><i class="far fa-calendar"></i><span>July 25, 2024</span></li>
                            ...
                            <div id="collapseOne" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="heading1">
                                <div class="panel-body">
                                    <p>Weaponts can appreciate our broad services akshay handge pharetra, eratd fermentum feugiat, gun are best velit mauris aks egestasut aliquam. This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor. Read More</p>
                                    <div class="col-sm-8 pd-0">
                                        <div class="events-img">
                                            <div><img src="assets/images/events/1.jpg" alt="" /></div>
                                            <div><img src="assets/images/events/2.jpg" alt="" /></div>
                                            <div><img src="assets/images/events/3.jpg" alt="" /></div>
                                            <div><img src="assets/images/events/1.jpg" alt="" /></div>
                                            <div><img src="assets/images/events/2.jpg" alt="" /></div>
                                        </div>
                                    </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="heading2">
                                <a role="button" data-bs-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="true" aria-controls="collapseOne" class="cnc btncnc">
                                    <h3>Modern Weapon Trainning Seminar</h3>
                                    <ul>
                                        <li><i class="far fa-calendar"></i><span>July 25, 2024</span></li>
                                        <li><i class="far fa-clock"></i><span>EST 11.00 to 5.00</span></li>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="heading3">
                                <a role="button" data-bs-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="true" aria-controls="collapseOne" class="cnc btncnc">
                                    <h3>Modern Weapon Trainning Seminar</h3>
                                    <ul>
                                        <li><i class="far fa-calendar"></i><span>July 25, 2024</span></li>
                                        <li><i class="far fa-clock"></i><span>EST 11.00 to 5.00</span></li>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="videos-area text-center">
                        <div class="video-popups">
                            <a href="https://youtu.be/ZrGzRmcIFcU" class="video-play-icon"><i class="fas fa-play"></i></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 pd-0">
                    <div class="map-conts">
                        <h1>Address</h1>
                        <ul>
                            <li><span>A. : 222, Laxman Nagar <br>Victoria House India.</span></li>
                            <li><span>P. : + 123 456 789</span></li>
                            <li><span>E. : weapon@example.com</span></li>
                        </ul>
                    </div>
                    <div class="map-area">
                        <div id="map" class="map-full" style="width:100%; height:600px;"></div>
                    </div>
                </div>
            </div>
        </div>
