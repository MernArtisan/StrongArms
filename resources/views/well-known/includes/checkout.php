            ...
            <section class="checkout-section">
                ...
                <div class="checkout-form-grid">
                    ...
                    <div class="checkout-form-group checkout-col-2">
                        ...
                        <select class="checkout-select" required>
                    ...
                    <div class="checkout-form-group checkout-col-2">
                        ...
                        <select class="checkout-select" required>
                            ...
                            <!-- Other country options would go here -->
                        </select>
                    </div>
                    <div class="checkout-form-group">
                ...
                <div class="checkout-ffl-section">
                    ...
                    <div class="checkout-ffl-toggle">
                        <input type="checkbox" id="checkout-ffl-required">
                        <label for="checkout-ffl-required">This order contains firearms requiring FFL transfer</label>
                    </div>
                    ...
                    <div class="checkout-ffl-details" style="display:none;">
                        ...
                        <button class="checkout-ffl-find-btn">FIND NEAREST FFL DEALER</button>
                    </div>
                </div>
            </section>
        </div>
                ...
                <div class="checkout-review-items">
                    <div class="checkout-review-item">
                        <div class="checkout-review-product">
                            <img src="assets/images/products/100.jpg" alt="AR-15" class="checkout-review-img">
                            <div>
                                <h4 class="checkout-review-name">Tactical AR-15 Rifle</h4>
                                <p class="checkout-review-sku">SKU: AR15-TAC-556</p>
                            </div>
                        </div>
                        <div class="checkout-review-qty">1</div>
                        <div class="checkout-review-price">$899.99</div>
                    </div>
                    
                    <div class="checkout-review-item">
                        <div class="checkout-review-product">
                            <img src="assets/images/products/101.jpg" alt="Glock 19" class="checkout-review-img">
                            <div>
                                <h4 class="checkout-review-name">Glock 19 Gen 5</h4>
                                <p class="checkout-review-sku">SKU: GLK19-G5-9mm</p>
                            </div>
                        </div>
                        <div class="checkout-review-qty">1</div>
                        <div class="checkout-review-price">$549.99</div>
                    </div>
                    
                    <div class="checkout-review-item">
                        <div class="checkout-review-product">
                            <img src="assets/images/products/102.jpg" alt="Ammo" class="checkout-review-img">
                            <div>
                                <h4 class="checkout-review-name">9mm FMJ Ammunition (50 rds)</h4>
                                <p class="checkout-review-sku">SKU: AMMO-9MM-50</p>
                            </div>
                        </div>
                        <div class="checkout-review-qty">3</div>
                        <div class="checkout-review-price">$74.97</div>
                    </div>
                </div>
                
                <div class="checkout-agreements">
                    <div class="checkout-agreement">
                        <input type="checkbox" id="checkout-age-verify" required>
                        <label for="checkout-age-verify">I certify that I am at least 21 years old and legally eligible to purchase these items *</label>
                    </div>
                    <div class="checkout-agreement">
                        <input type="checkbox" id="checkout-terms" required>
                        <label for="checkout-terms">I agree to the Terms of Service and Privacy Policy *</label>
                    </div>
                    <div class="checkout-agreement">
                        <input type="checkbox" id="checkout-background-check" required>
                        <label for="checkout-background-check">I understand a background check is required for firearm purchases *</label>
                    </div>
                </div>
                
                <button class="checkout-submit-btn">PLACE ORDER <i class="fas fa-lock"></i></button>
            </section>
            </div>  
        </div>
			<!---my-code--->
