            ...
            <div class="row">
                    ...
                    <div class="products-photo">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#img1" role="tab" data-bs-toggle="tab"><img src="assets/images/products/1.jpg" alt="" /></a>
                            </li>
                            <li role="presentation">
                                <a href="#img2" role="tab" data-bs-toggle="tab"><img src="assets/images/products/2.jpg" alt="" /></a>
                            </li>
                            <li role="presentation">
                                <a href="#img3" role="tab" data-bs-toggle="tab"><img src="assets/images/products/3.jpg" alt="" /></a>
                            </li>
                            <li role="presentation">
                                <a href="#img4" role="tab" data-bs-toggle="tab"><img src="assets/images/products/4.jpg" alt="" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="single-product-content">
                        ...
                        <div class="con">
                            <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. aks Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nibh id elit. Duis sed odio sit amet.</p>
                            <ul>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="pro-details">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="myTab">
                            <li role="presentation" class="nav-item "><a class="active"  role="tab" data-bs-toggle="tab" data-bs-target="#home" id="home-tab">Description</a></li>
                            <li class=""  role="presentation"><a id="profile-tab" role="tab" data-bs-toggle="tab" data-bs-target="#profile">Specification</a></li>
                            <li class="nav-item"  role="presentation"><a id="contact-tab" role="tab" data-bs-toggle="tab" data-bs-target="#contact" >Reviews   </a></li>
                            <li role="presentation"><a id="setting-tab" role="tab" data-bs-toggle="tab" data-bs-target="#setting"> Faq.</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
