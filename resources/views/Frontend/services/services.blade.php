                ...
                <div class="container mb-5">
                    <div class="card text-white bg-dark shadow-lg" style="border-radius: 20px; overflow: hidden;">
                        <div class="row no-gutters">
                            <!-- Card Image -->
                            <div class="col-md-5">
                                <img src="{{ asset($service->image) }}" class="img-fluid h-100 w-100"
                                    style="object-fit: cover;" alt="Car Image">
                            </div>
                            ...
                            <div class="col-md-7 d-flex flex-column justify-content-between p-4">
                                <div>
                                    ...
                                    <img src="{{ asset($service->user->image) }}" class="img-fluid"
                                        style="object-fit: cover;width: 40px;height: 40px;border-radius: 40%;"
                                        alt="Car Image"> {{ $service->user->name }}
