        ...
        <div class="container">
            <div class="form-box">
                ...
                <p class="text-center text-muted mb-4" style="color: #fff !important">
                    Join as a certified trainer to offer your expertise to clients, manage training sessions, and grow your business with our powerful dashboard.
                </p>

                <form id="trainerRegisterForm" action="{{ route('registertrainer.submit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="autocomplete" name="store_location" placeholder="Store Location">
                            <input type="hidden" name="latitude" id="latitude">
                            <input type="hidden" name="longitude" id="longitude">
                        </div>

                        <div class="col-md-6">
                            <input type="text" class="form-control" name="established_since" placeholder="Established Since (Year)">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="text-center mt-3">
                        <small class="text-muted" style="color: #fff !important">By registering, you agree to our <a href="#">Terms</a> and <a href="#">Privacy Policy</a>.</small><br>
                        <small class="text-muted" style="color: #fff !important">Already have an account? <a href="{{ route('login') }}">Login here.</a></small>
                    </div>
                </form>
            </div>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2zcZWYTrnjovVYwCR9zwHJwVEtUEufJk&libraries=places"></script>
    ...
    $(document).ready(function () {
        ...
        $('#logoInput').on('change', function (event) {
            ...
            reader.onload = function () {
                $('#logoPreview').html(`<img src="${reader.result}" alt="Logo" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">`);
            };
